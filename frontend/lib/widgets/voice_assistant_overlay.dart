          ...
          child: Column(
            ...
            children: [
              ...
              _resultLine(
                ...
                recommendation.isTrusted
                    ? (_presentInTamil ? 'அதிகாரப்பூர்வ மூலத்தில் சரிபார்க்கப்பட்டது' : 'Current official source verified')
                    : (_presentInTamil ? 'விண்ணப்பிக்கும் முன் சரிபார்க்கவும்' : 'Uncertain or historical — verify before applying'),
                recommendation.isTrusted
              ...
              (match) => Padding(
                ...
                child: Material(
                  ...
                  child: ListTile(
                    ...
                    title: Text(
                      match.scheme.toLocalized(_presentInTamil ? 'ta' : 'en').name,
                      style: const TextStyle(
                        color: Colors.white,
                        fontSize: 11,
                        fontWeight: FontWeight.w700,
