...
class QuestionNode {
  ...
  LocalizedQuestionNode toLocalized(String language) {
    ...
    for (int i = 0; i < options.length; i++) {
      ...
      if (isTamil) {
        if (optionsTa != null && i < optionsTa!.length && optionsTa![i].trim().isNotEmpty) {
...
class _SmartAssessmentBottomSheetState extends State<SmartAssessmentBottomSheet> {
  ...
  void _initializeFlow() {
    ...
    if (widget.cardType == 'category') {
      ...
      } else if (title.contains('agri') || title.contains('farm') || title.contains('crop')) {
        _questionFlow = _getAgricultureFlow();
        _currentQuestionId = 'agri_q1';
      } else if (title.contains('skill') || title.contains('employ') || title.contains('job')) {
        _questionFlow = _getSkillFlow();
        _currentQuestionId = 'skill_q1';
      } else if (title.contains('tech') || title.contains('export') || title.contains('trade')) {
        _questionFlow = _getTechExportFlow();
        _currentQuestionId = 'te_q1';
      } else if (title.contains('business') || title.contains('msme') || title.contains('start') || title.contains('artisan') || title.contains('loan') || title.contains('credit')) {
  ...
  void _onOptionSelected(String selectedLocalizedOption, LocalizedQuestionNode localizedNode) {
    setState(() {
      // Find raw option string for downstream answer logic
      final index = localizedNode.options.indexOf(selectedLocalizedOption);
      final rawOption = (index >= 0 && index < localizedNode.rawNode.options.length)
  ...
  void _submitAnswers() {
    ...
    _answers.forEach((qId, ans) {
      if (qId.contains('income') || qId.contains('turnover') || qId.endsWith('q5') || qId.contains('q4_income')) {
        if (ans.contains('Under ₹1') || ans.contains('Under ₹1.2') || ans.contains('Under ₹1.5') || ans.contains('Under ₹1.8')) {
          ...
          income = 200000.0;
        } else if (ans.contains('₹2.5') || ans.contains('₹1.8 - ₹3') || ans.contains('₹2 - ₹8') || ans.contains('₹1.5 - ₹5')) {
          income = 450000.0;
        } else if (ans.contains('Over ₹8') || ans.contains('Over ₹6') || ans.contains('Over ₹10') || ans.contains('Over ₹5')) {
          income = 900000.0;
        }
      }
      ...
      if (qId.contains('livelihood') || qId.contains('profession') || qId.contains('occupation') || qId.contains('employment')) {
  ...
  Widget build(BuildContext context) {
    ...
    final cardTitleLocalized = _getLocalizedCardTitle(widget.cardTitle, language);
          ...
          AnimatedSwitcher(
            ...
            child: Column(
              ...
              children: [
                ...
                if (localizedNode.subtitleText != null && localizedNode.subtitleText!.isNotEmpty) ...[
                ...
                ...List.generate(localizedNode.options.length, (index) {
                  ...
                  return Container(
                    ...
                    child: OutlinedButton(
                      onPressed: () => _onOptionSelected(optionLocalized, localizedNode),
  ...
  Map<String, QuestionNode> _getEducationFlow() {
    return {
      ...
      'edu_q2_school': QuestionNode(
        ...
        optionsTa: ["வகுப்பு 1 - 8 (தொடக்கப்பள்ளி)", "வகுப்பு 9 - 10 (உயர்நிலைப்பள்ளி)", "வகுப்பு 11 - 12 (மேல்நிலைப்பள்ளி)"],
      ...
      'edu_q2_college': QuestionNode(
        ...
        optionsTa: ["STEM (அறிவியல்/பொறியியல்/IT)", "கலை, வணிகவியல் & மானுடவியல்", "மருத்துவம் & செவிலியர்", "வேளாண் படிப்புகள்"],
      ...
      'edu_q2_research': QuestionNode(
        ...
        optionsTa: ["STEM ஆராய்ச்சி & காப்புரிமை", "மானுடவியல் & சமூக அறிவியல்", "வேளாண் / உயிரியல் அறிவியல்"],
      ...
      'edu_q3_school': QuestionNode(
        ...
        optionsTa: ["பள்ளிப்படிப்பு உதவித்தொகை (Pre-matric)", "இலவச பாடப்புத்தகங்கள் & சீருடைகள்", "விடுதி தங்குமிட மானியம்"],
      ...
      'edu_q3_college': QuestionNode(
        ...
        optionsTa: ["ஆம், கல்விக்கடன் தேவை", "இல்லை, கல்வி உதவித்தொகை மட்டும் தேவை"],
        nextId: (_) => "edu_q4_caste",
      ),
      'edu_q3_research': QuestionNode(
        id: 'edu_q3_research',
        questionText: "Are you seeking a research fellowship or international study grant?",
        questionTextTa: "ஆராய்ச்சி உதவித்தொகை அல்லது வெளிநாட்டு கல்வி நிதி எதிர்பார்க்கிறீர்களா?",
        options: ["National Fellowship grant", "International study allowance", "Merit publication awards"],
        optionsTa: ["தேசிய ஆராய்ச்சி நிதி (Fellowship)", "வெளிநாட்டு கல்வி உதவித்தொகை", "ஆராய்ச்சி கட்டுரை விருதுகள்"],
        nextId: (_) => "edu_q4_caste",
      ),
      'edu_q4_caste': QuestionNode(
        ...
        optionsTa: ["பொதுப்பிரிவு (General)", "பிற்படுத்தப்பட்டோர் (OBC/BC)", "பட்டியல் வகுப்பினர் (SC / ST)", "பொருளாதாரத்தில் பின்தங்கியோர் / சிறுபான்மையினர்"],
      ...
      'edu_q5_income': QuestionNode(
        ...
        optionsTa: ["₹2.5 இலட்சத்திற்குக் கீழ்", "₹2.5 இலட்சம் - ₹8 இலட்சம்", "₹8 இலட்சத்திற்கு மேல்"],
        nextId: (_) => null,
      ),
    };
  }
  ...
  Map<String, QuestionNode> _getWomenFlow() {
    return {
      'women_q1': QuestionNode(
        ...
        optionsTa: ["கர்ப்பிணி அல்லது பாலூட்டும் தாய்", "பெண் குழந்தை (பெற்றோர் விண்ணப்பிக்கின்றனர்)", "பெண் தொழில்முனைவோர்", "தனித்து வாழும் பெண் / விதவை தாய்"],
      ...
      'women_q2_maternal': QuestionNode(
        ...
        optionsTa: ["முதல் கர்ப்பம்", "இரண்டாவது கர்ப்பம்", "இரண்டிற்கும் மேற்பட்டவை"],
      ...
      'women_q2_girl': QuestionNode(
        ...
        optionsTa: ["பிறந்த குழந்தை (0 - 1 வயது)", "குழந்தை (2 - 10 வயது)", "இளம் பெண் (11 - 18 வயது)"],
      ...
      'women_q2_biz': QuestionNode(
        ...
        questionTextTa: "நிறுவனத்தில் பெண்களுக்கு குறைந்தது 51% பங்கீடு உள்ளதா?",
        options: ["Yes, fully owned by women", "No, minor/shared stake"],
        optionsTa: ["ஆம், முழுவதும் பெண்கள் உரிமையிலானது", "இல்லை, குறைந்த பங்கீடு"],
      ...
      'women_q2_welfare': QuestionNode(
        ...
        questionTextTa: "உங்களிடம் வறுமைக் கோட்டிற்கு கீழ் (BPL) குடும்ப அட்டை உள்ளதா?",
      ...
      'women_q3_matern_reg': QuestionNode(
        ...
        questionTextTa: "உள்ளூர் அங்கன்வாடி / சுகாதார மையத்தில் பதிவு செய்துள்ளீர்களா?",
        options: ["Yes, registered", "No, not registered yet"],
        optionsTa: ["ஆம், பதிவு செய்யப்பட்டுள்ளது", "இல்லை, இன்னும் பதிவு செய்யவில்லை"],
      ...
      'women_q3_girl_save': QuestionNode(
        ...
        questionTextTa: "செல்வமகள் சேமிப்பு கணக்கு (Sukanya Samriddhi) தொடங்க விரும்புகிறீர்களா?",
        options: ["Yes, open savings account", "No, seeking educational scholarships"],
        optionsTa: ["ஆம், சேமிப்பு கணக்கு தொடங்க வேண்டும்", "இல்லை, கல்வி உதவித்தொகை தேவை"],
        nextId: (_) => "women_q4_caste",
      ),
      'women_q3_girl_edu': QuestionNode(
        ...
        optionsTa: ["ஆம், பள்ளி / கல்லூரியில் படிக்கிறார்", "இல்லை, படிப்பை நிறுத்திவிட்டார்"],
        nextId: (_) => "women_q4_caste",
      ),
      'women_q3_biz_credit': QuestionNode(
        ...
        optionsTa: ["குறுங்கடன் (₹1 இலட்சத்திற்கு கீழ்)", "MSME கடன் (₹1 இலட்சம் - ₹10 இலட்சம்)", "ஸ்டாண்ட்-அப் இந்தியா கடன் (₹10 இலட்சத்திற்கு மேல்)"],
        nextId: (_) => "women_q4_caste",
      ),
      'women_q3_welfare_pension': QuestionNode(
        ...
        optionsTa: ["ஆம், விதவை ஓய்வூதியம் பெறுகிறேன்", "இல்லை, ஓய்வூதியம் பெறவில்லை"],
        nextId: (_) => "women_q4_caste",
      ),
      'women_q4_caste': QuestionNode(
        ...
        optionsTa: ["பொதுப்பிரிவு (General)", "பிற்படுத்தப்பட்டோர் (OBC/BC)", "பட்டியல் வகுப்பினர் (SC / ST)", "சிறுபான்மையினர் / EWS"],
      ...
      'women_q5_income': QuestionNode(
        ...
        optionsTa: ["₹1.5 இலட்சத்திற்குக் கீழ்", "₹1.5 இலட்சம் - ₹5 இலட்சம்", "₹5 இலட்சத்திற்கு மேல்"],
        nextId: (_) => null,
      ),
    };
  }
  ...
  Map<String, QuestionNode> _getBusinessFlow() {
    return {
      'biz_q1': QuestionNode(
        ...
        optionsTa: ["ஆம், MSME உத்யம் மூலம்", "ஆம், DPIIT ஸ்டார்ட்அப்பாக", "இல்லை, தனிநபர் வியாபாரி / கைவினைஞராக", "இல்லை, யோசனை நிலையில் உள்ளது"],
      ...
      'biz_q2_msme': QuestionNode(
        ...
        optionsTa: ["குறுந்தொழில் (₹1 கோடிக்கு கீழ்)", "சிறு தொழில் (₹1 கோடி - ₹10 கோடி)", "நடுத்தர தொழில் (₹10 கோடிக்கு மேல்)"],
      ...
      'biz_q2_startup': QuestionNode(
        ...
        optionsTa: ["மாதிரி வடிவம் / MVP உருவாக்கம்", "ஆரம்ப வருவாய் / சந்தை சரிபார்ப்பு", "தொழில் விரிவாக்கம்"],
      ...
      'biz_q2_artisan': QuestionNode(
        ...
        questionTextTa: "உங்களிடம் பிஎம் விஸ்வகர்மா அட்டை / கைவினைஞர் சான்றிதழ் உள்ளதா?",
        options: ["Yes, active card", "No, not registered"],
        optionsTa: ["ஆம், செயலில் உள்ள அட்டை உள்ளது", "இல்லை, பதிவு செய்யவில்லை"],
      ...
      'biz_q2_idea': QuestionNode(
        ...
        optionsTa: ["ஆம், திட்ட அறிக்கை தயார்", "இல்லை, திட்ட வழிகாட்டுதல் தேவை"],
        nextId: (_) => "biz_q3_msme_need",
      ),
      'biz_q3_msme_need': QuestionNode(
        ...
        optionsTa: ["பிணையமில்லா முத்ரா கடன்", "நடைமுறை மூலதன உத்தரவாதம் (CGTMSE)", "இயந்திரங்கள் வாங்குவதற்கான மூலதன மானியம்"],
      ...
      'biz_q3_startup_need': QuestionNode(
        ...
        questionTextTa: "பங்கு மூலதன நிதி அல்லது வரி விலக்கு எதிர்பார்க்கிறீர்களா?",
        options: ["Government Seed Funding", "Section 80-IAC Tax Exemption", "Incubator mentoring grant"],
        optionsTa: ["அரசு தொடக்க நிதி (Seed Funding)", "பிரிவு 80-IAC வரி விலக்கு", "இன்குபேட்டர் வழிகாட்டுதல் மானியம்"],
        nextId: (_) => "biz_q4_demographics",
      ),
      'biz_q3_artisan_need': QuestionNode(
        ...
        optionsTa: ["இலவச கருவித்தொகுப்பு (Toolkit) வவுச்சர்", "கண்காட்சி மற்றும் அரங்கு மானியம்", "கைவினைஞர்களுக்கான தனிநபர் குறுங்கடன்"],
        nextId: (_) => "biz_q4_demographics",
      ),
      'biz_q4_demographics': QuestionNode(
        ...
        optionsTa: ["ஆம், பெண் தொழில்முனைவோர்", "ஆம், SC/ST தொழில்முனைவோர்", "ஆம், SC/ST மற்றும் பெண்", "பொதுப்பிரிவு ஆண்"],
      ...
      'biz_q5_turnover': QuestionNode(
        ...
        optionsTa: ["₹10 இலட்சத்திற்குக் கீழ்", "₹10 இலட்சம் - ₹50 இலட்சம்", "₹50 இலட்சம் - ₹2 கோடி", "₹2 கோடிக்கு மேல்"],
        nextId: (_) => null,
      ),
    };
  }
  ...
  Map<String, QuestionNode> _getAgricultureFlow() {
    return {
      'agri_q1': QuestionNode(
        ...
        options: ["Small / Marginal (Under 2 Hectares)", "Medium (2 - 5 Hectares)", "Large / Commercial (Over 5 Hectares)", "Tenant / Landless Farmer"],
        optionsTa: ["சிறு / குறு விவசாயி (2 ஹெக்டேருக்கு கீழ்)", "நடுத்தர விவசாயி (2 - 5 ஹெக்டேர்)", "பெரிய விவசாயி (5 ஹெக்டேருக்கு மேல்)", "குத்தகை / நிலமற்ற விவசாயி"],
        nextId: (_) => "agri_q2",
      ),
      'agri_q2': QuestionNode(
        ...
        options: ["PM-KISAN Cash Transfer", "Drip Irrigation / Equipment Subsidy", "Crop Insurance & Disaster Relief", "Kisan Credit Card (KCC) Loan"],
        optionsTa: ["PM-KISAN நேரடி நிதி உதவி", "சொட்டு நீர் பாசனம் / உபகரண மானியம்", "பயிர் காப்பீடு & பேரிடர் நிவாரணம்", "கிசான் கிரெடிட் கார்டு (KCC) கடன்"],
      ...
      'agri_q3_caste': QuestionNode(
        ...
        optionsTa: ["பொதுப்பிரிவு (General)", "பிற்படுத்தப்பட்டோர் (OBC/BC)", "பட்டியல் வகுப்பினர் (SC / ST)", "சிறப்பு விவசாயி பிரிவு"],
  ...
  Map<String, QuestionNode> _getSkillFlow() {
    return {
      'skill_q1': QuestionNode(
        ...
        options: ["Unemployed youth seeking job", "School/College dropout", "Traditional artisan / Worker", "Employed seeking skill upgrade"],
        optionsTa: ["வேலைதேடும் இளைஞர்", "பள்ளி / கல்லூரி இடைநின்றவர்", "பாரம்பரிய தொழிலாளி / பணியாளர்", "திறன் மேம்பாடு விரும்பும் பணியாளர்"],
        nextId: (_) => "skill_q2",
      ),
      'skill_q2': QuestionNode(
        ...
        options: ["IT, Digital & Electronics", "Apparel, Textile & Handicrafts", "Automotive & Mechanical", "Healthcare & Hospitality"],
        optionsTa: ["தகவல் தொழில்நுட்பம் & எலக்ட்ரானிக்ஸ்", "ஆடை வடிவமைப்பு & கைவினை", "வாகனம் & மெக்கானிக்கல்", "சுகாதாரம் & விருந்தோம்பல்"],
        nextId: (_) => "skill_q3",
      ),
      'skill_q3': QuestionNode(
        id: 'skill_q3',
        questionText: "Are you looking for government-certified PMKVY training?",
        questionTextTa: "அரசு அங்கீகாரம் பெற்ற இலவசப் பயிற்சி பெற விரும்புகிறீர்களா?",
        options: ["Yes, need certified training", "No, seeking self-employment stipend"],
        optionsTa: ["ஆம், சான்றிதழ் பயிற்சி தேவை", "இல்லை, சுயதொழில் உதவித்தொகை தேவை"],
  ...
  Map<String, QuestionNode> _getTechExportFlow() {
    return {
      'te_q1': QuestionNode(
        ...
        options: ["Technology / R&D Innovation", "Export & Trade Expansion", "Manufacturing Production Unit", "Digital Infrastructure"],
        optionsTa: ["தொழில்நுட்பம் / R&D ஆராய்ச்சி", "ஏற்றுமதி & வர்த்தக விரிவாக்கம்", "உற்பத்தி ஆலை (Manufacturing)", "டிஜிட்டல் கட்டமைப்பு"],
        nextId: (_) => "te_q2",
      ),
      'te_q2': QuestionNode(
        id: 'te_q2',
        ...
        options: ["Capital Investment Subsidy", "Patent & R&D Filing Reimbursement", "Market Access & International Fair Grant", "Software & Hardware Infrastructure Support"],
        optionsTa: ["மூலதன முதலீட்டு மானியம்", "காப்புரிமை & R&D கட்டணத் திரும்பப்பெறுதல்", "சர்வதேச வர்த்தகக் கண்காட்சி மானியம்", "மென்பொருள் & வன்பொருள் கட்டமைப்பு"],
      ...
      'te_q3_turnover': QuestionNode(
        ...
        optionsTa: ["₹50 இலட்சத்திற்குக் கீழ்", "₹50 இலட்சம் - ₹5 கோடி", "₹5 கோடிக்கு மேல்"],
        nextId: (_) => null,
      ),
    };
  }
  ...
  Map<String, QuestionNode> _getDefaultCategoryFlow() {
    return {
      'cat_q1': QuestionNode(
        ...
        optionsTa: ["மாணவர்", "விவசாயி", "தொழிலதிபர் / சுயதொழில்", "வேலையில்லாதவர் / பணியாளர்"],
        nextId: (_) => "cat_q2",
      ),
      'cat_q2': QuestionNode(
        id: 'cat_q2',
        questionText: "Are you seeking financial credit or direct subsidy grants?",
        questionTextTa: "நிதிக் கடன் அல்லது நேரடி மானியங்களை எதிர்பார்க்கிறீர்களா?",
        options: ["Business / Study Loans", "Subsidies & welfare grants", "Free skill training / services"],
        optionsTa: ["தொழில் / கல்வி கடன்கள்", "மானியங்கள் & நலத்திட்ட உதவிகள்", "இலவச திறன் பயிற்சி / சேவைகள்"],
        nextId: (_) => "cat_q3",
      ),
      'cat_q3': QuestionNode(
        id: 'cat_q3',
  ...
  Map<String, QuestionNode> _getStateFlow(String stateName) {
    return {
      'state_q1': QuestionNode(
        ...
        optionsTa: ["ஆம், இருப்பிட சான்றிதழ் உள்ளது", "இல்லை, தற்காலிகமாக வசிக்கிறேன்"],
        nextId: (_) => "state_q2",
      ),
      'state_q2': QuestionNode(
        id: 'state_q2',
        questionText: "What is your category in the $stateName state reservation list?",
        questionTextTa: "$stateName மாநில இடஒதுக்கீடு பட்டியலில் உங்கள் பிரிவு என்ன?",
        options: ["BC / SEBC / OBC", "SC / ST", "EWS / Minority", "General / Open"],
        optionsTa: ["BC / MBC / OBC", "SC / ST", "EWS / சிறுபான்மையினர்", "பொதுப்பிரிவு (Open)"],
        nextId: (_) => "state_q3",
      ),
      'state_q3': QuestionNode(
        id: 'state_q3',
        questionText: "What is your primary livelihood sector in $stateName?",
        questionTextTa: "$stateName மாநிலத்தில் உங்கள் முதன்மை வாழ்வாதாரத் துறை என்ன?",
        options: ["Agriculture / Farmer", "MSME / Startup owner", "Weaving / Traditional Crafts", "Student / Higher studies"],
        optionsTa: ["வேளாண்மை / விவசாயி", "MSME / ஸ்டார்ட்அப் உரிமையாளர்", "நெசவு / பாரம்பரிய கைவினைஞர்கள்", "மாணவர் / உயர்கல்வி"],
        nextId: (_) => "state_q4",
      ),
      'state_q4': QuestionNode(
        ...
        optionsTa: ["மாதாந்திர நிதியுதவி / உதவித்தொகை", "கல்விக் கட்டண விலக்கு", "தொழில் மானியங்கள்", "விவசாய உறைவிட உதவிகள்"],
        nextId: (_) => "state_q5",
      ),
  ...
  Map<String, QuestionNode> _getMinistryFlow(String ministryName) {
    return {
      'min_q1': QuestionNode(
        ...
        optionsTa: ["தொழில் மானியம் / கடனுக்கு விண்ணப்பித்தல்", "கல்வி உதவித்தொகை பெறுதல்", "விவசாய நிதி உதவிகள் பெறுதல்", "ஊரக மகளிர் சுயஉதவிக் குழு உதவிகள்"],
        nextId: (_) => "min_q2",
      ),
      'min_q2': QuestionNode(
        id: 'min_q2',
        ...
        optionsTa: ["18 - 35 வயது", "36 - 59 வயது", "60 வயது மற்றும் அதற்கு மேல்"],
        nextId: (_) => "min_q3",
      ),
      'min_q3': QuestionNode(
        id: 'min_q3',
        ...
        optionsTa: ["ஆம், உத்யம் / PM-KISAN / மாணவர் சான்று எண்", "இல்லை, இன்னும் பதிவு செய்யவில்லை"],
        nextId: (_) => "min_q4",
      ),
      'min_q4': QuestionNode(
        id: 'min_q4',
        ...
        optionsTa: ["பொதுப்பிரிவு (General)", "பிற்படுத்தப்பட்டோர் (OBC/BC)", "பட்டியல் வகுப்பினர் (SC / ST)", "சிறுபான்மையினர் / மாற்றுத்திறனாளி"],
        nextId: (_) => "min_q5",
      ),
      'min_q5': QuestionNode(
        id: 'min_q5',
