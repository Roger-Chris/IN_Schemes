        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // 3. Mic and Waves (Outside the Box)
              GestureDetector(
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            const Icon(Icons.keyboard, color: kBrandBlue, size: 20),
                          ],
                        ),
                      ),
                    ],
              ...
              // 4. Try Asking Saarthi Quick Action Row
              Column(
                ...
                child: Row(
                  children: [
                    ...
                    Container(
                      ...
                      child: const Icon(Icons.outlined_flag_rounded, color: kBrandBlue, size: 24),
                    ),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          OutlinedButton(
                            ...
                            onPressed: () => openCompanionVoiceAgent(context, initialText: 'How can I register UDYAM?'),
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Text(
                                  'Continue',
                                  style: GoogleFonts.inter(fontSize: 10.5, fontWeight: FontWeight.bold, color: kBrandBlue),
                                ),
                                const SizedBox(width: 4),
                                const Icon(Icons.arrow_forward, size: 10, color: kBrandBlue),
                              ],
                            ),
                          ),
                        ],
              ...
              // 6. Recent Conversations Section
              Column(
                crossAxisAlignment: CrossAxisAlignment.stretch,
                children: [
                  Row(
